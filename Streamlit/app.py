...
from utils import load_data, generate_matrix_figure, load_model, preprocess_data, predict_prematurity
...
def understand_prematurity():
    ...
    st.write("The primary distinction between preterm and full-term birth is the gestational age, or how long the baby was in the womb at birth.")
    st.markdown("""
...
def plot_and_predict(matrices, model, X, y):
    ...
    if matrices is not None:
        ...
        with col1:
            ...
            matrix_index = st.number_input("Select a connectivity matrix", min_value=1, max_value=matrices.shape[0], value=1)
